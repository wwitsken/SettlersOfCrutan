...
public class EntrySpecTests
{
    ...
    {
        var ctx = new JoinSpecs.JoinPlayerContext(GameId, Player.Create("p1"));
    ...
    {
        var ctx = new LeaveSpecs.LeavePlayerContext(GameId, P1, Player.Create("p1"));
    ...
    {
        var ctx = new NameSpecs.PlayerSetNameContext(GameId, P1, Player.Create("p1"));
    ...
    {
        var a = Player.Create("a");
        var b = Player.Create("b");
